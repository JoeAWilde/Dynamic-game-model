...
int main()
{
    ...
    for(int tide=0; tide<tides; tide++)
    {
        for(int t=0; t<tSteps; t++)
        {
            ...
            /* if(t < 60)
            {
                pFemMinList[tide][t] = pFemMin + 0.0009 * t; 
                pFemMaxList[tide][t] = pFemMax + 0.0009 * t; 
                
            }
            else
            {
                pFemMinList[tide][t] = pFemMinList[tide][t-1] -  (0.0009 * 2);
                pFemMaxList[tide][t] = pFemMaxList[tide][t-1] -  (0.0009 * 2);
